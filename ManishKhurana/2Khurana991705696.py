...
while (running != False):
    ...
    print("******************************************************************************")
    print()
    #numberOfSensor=(input("Enter the number of sensors deployed across Sheridan Campus: "))   # we declared a variable for number of sensors we wanna input
    #print()
    while(ask!=False):
        numberOfSensor=(input("Enter the number of sensors deployed across Sheridan Campus: "))   # we declared a variable for number of sensors we wanna input
        if(numberOfSensor==str and numberOfSensor != int):
            print("Please enter a numerical value greater than 0")
            continue
        elif(numberOfSensor==int):
